 ...
 * leftPos and topPos should be set to zero if they are not known at the time of instantiation.
 * automatically.
 * @param leftPos       the int in screen relative terms of the leftmost screen coordinate to render to.
 * @param topPos        the int in screen relative terms of the topmost screen coordinate to render to.
